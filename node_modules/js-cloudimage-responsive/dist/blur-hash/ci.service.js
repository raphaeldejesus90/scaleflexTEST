...
var CIResponsive = /*#__PURE__*/function () {
  function CIResponsive(_config) {
    ...
    this.config = (0, _ci2.getInitialConfigBlurHash)(_config);
  ...
  _createClass(CIResponsive, [{
    ...
    value: function processImage(props) {
      ...
      var ratio = containerProps.ratio;
      var dataSrcAttr = config.dataSrcAttr;
      var wrapper = (0, _ci3.applyOrUpdateWrapper)(_objectSpread({
        isUpdate: isUpdate,
        imgNode: imgNode,
        ratio: ratio
      }, imgProps));
      ...
      if (!isUpdate) {
        (0, _ci3.initImageClasses)(imgNode, lazy);
        (0, _ci3.initImageStyles)(imgNode);

        if (config.destroyNodeImgSize) {
          (0, _ci.destroyNodeImgSize)(imgNode);
        }

        var canvas = (0, _ci3.applyOrUpdateBlurHashCanvas)(wrapper, blurHash);
      ...
      (0, _ci.setSrc)(imgNode, cloudimageUrl, null, lazy, src, isSVG, dataSrcAttr);
    }
  }, {
    ...
    value: function processBackgroundImage(props) {
      ...
      if (!isUpdate) {
        (0, _ci3.initImageBackgroundClasses)(imgNode, lazy);
        (0, _ci3.initImageBackgroundStyles)(imgNode);
        var canvas = (0, _ci3.applyOrUpdateBlurHashCanvas)(imgNode, blurHash);
        ...
        if (!lazy) {
          ...
          tempImage.onload = function () {
            (0, _ci3.finishAnimation)(imgNode, blurHash && canvas);
          };
        }
      }
